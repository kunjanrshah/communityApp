...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_TEXT_SIZE_SP = 52;
    ...
    public void changeTabTitleTextColor(int color) {
        for (int i = 0; i < mAllTabs.size(); i++) {
            TextView textView = mAllTabs.get(i).findViewById(mTabViewTextViewId);
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, TAB_VIEW_TEXT_SIZE_SP);
