...
import static com.krs.community.activity.MapTrackingActivity.JOB_STATE_CHANGED;
import static com.krs.community.activity.MapTrackingActivity.LOCATION_ACQUIRED;
...
//                            startService(i1); //i have disabled the call as the server URL in intent service is dummy URL. Change the URL to your server URL and call this intent service
    ...
    private void createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notification = mBuilder.setSmallIcon(R.drawable.placeholder).setTicker("Tracking").setWhen(0)
                    .setAutoCancel(false)
            ...
            notification = mBuilder.setSmallIcon((Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) ? R.drawable.placeholder : R.drawable.ic_app).setTicker("Tracking").setWhen(0)
                    .setAutoCancel(false)
                    .setCategory(Notification.EXTRA_BIG_TEXT)
                    .setContentTitle("Tracking")
