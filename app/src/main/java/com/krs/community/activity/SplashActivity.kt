...
//        onCreateMethod()
    ...
    private fun setAnimation() {
        val generator = RandomTransitionGenerator(10000, AccelerateDecelerateInterpolator())
        kbv!!.setTransitionGenerator(generator)
        if (BuildConfig.FLAVOR == "medk") {
            imgLogo!!.visibility = View.VISIBLE
            imgLogo!!.animate().setStartDelay(1000).setDuration(1000).alpha(1f).start()
        } else {
            llLogo!!.visibility = View.VISIBLE
            llLogo!!.animate().setStartDelay(1000).setDuration(1000).alpha(1f).start()
        }
        ...
        llSpinner!!.animate().translationY(0f).setDuration(2000).alpha(1f).setStartDelay(3000).start()
        btnLogin!!.animate().translationX(dm!!.widthPixels + btnLogin!!.measuredWidth.toFloat()).setDuration(0).setStartDelay(0).start()
        btnLogin!!.animate().translationX(0f).setStartDelay(4000).setDuration(2000).setInterpolator(OvershootInterpolator()).start()
        btnRegister!!.animate().translationX(dm!!.widthPixels + btnRegister!!.measuredWidth.toFloat()).setDuration(0).setStartDelay(0).start()
        btnRegister!!.animate().translationX(0f).setStartDelay(4000).setDuration(2000).setInterpolator(OvershootInterpolator()).start()
    }
