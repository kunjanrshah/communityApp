...
public class Boys2Fragment extends Fragment implements OnPageChangeListener, OnLoadCompleteListener {
    public static final String SAMPLE_FILE = "boys_part2.pdf";
    PDFView pdfView;
    Integer pageNumber = 0;
    String pdfFileName;
    private String TAG = Boys2Fragment.class.getName();
