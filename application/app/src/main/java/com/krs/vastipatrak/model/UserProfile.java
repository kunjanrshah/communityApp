...
public class UserProfile extends RealmObject {
    ...
    public String getSpouse_father_name() {
        return spouse_father_name;
    }

    public void setSpouse_father_name(String spouse_father_name) {
        this.spouse_father_name = spouse_father_name;
    }

    public String getSpouse_mother_name() {
        return spouse_mother_name;
    }

    public void setSpouse_mother_name(String spouse_mother_name) {
