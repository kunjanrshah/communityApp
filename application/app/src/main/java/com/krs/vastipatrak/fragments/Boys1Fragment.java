...
public class Boys1Fragment extends Fragment implements OnPageChangeListener, OnLoadCompleteListener {
    public static final String SAMPLE_FILE = "boys_part1.pdf";
    PDFView pdfView;
    Integer pageNumber = 0;
    String pdfFileName;
    private String TAG = Boys1Fragment.class.getName();
