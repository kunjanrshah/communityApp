...
public class FamilyTreeDetailActivity extends AppCompatActivity implements ViewPagerFragmentBase.FragmentListener {
    ...
    public void onFragmentHeaderChanged(int position, int offset, int dx, int dy) {
        ...
        if (position == 0) {
            ...
            if (mOffset >= 0) {
                ...
                kv_header_img.setTranslationY(-newYPosition * 0.5f);
                ...
                kv_header_img.setTranslationY(0);
            ...
            kv_header_img.setTranslationY(-mFlexibleSpaceSize * 0.5f);
    ...
    private class FragmentViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            ...
            args.putString(KEY_VIEW_PAGER_FRAG_TYPE_STRING, getString(mViewPagerFragmentTitles[i]));
