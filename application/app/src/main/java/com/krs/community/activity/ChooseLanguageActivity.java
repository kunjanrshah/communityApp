...
public class ChooseLanguageActivity extends Activity {
    ...
    protected void onStart() {
        ...
        Intent mIntent = new Intent(ChooseLanguageActivity.this, DashboardActivity.class);
    ...
    private void MemoryAllocation() {
        ...
        splanguage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Utility.changeLang(ChooseLanguageActivity.this, splanguage.getSelectedItem().toString());
