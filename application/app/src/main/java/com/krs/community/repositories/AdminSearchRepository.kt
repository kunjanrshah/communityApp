...
class AdminSearchRepository(private val api: ApiServices, private val db:AppDatabase): SafeApiRequest()  {

    suspend fun getAdminSearch(jsonObject: JsonObject): SmartFilterResponse {
        return apiRequest{
