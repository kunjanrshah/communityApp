package com.krs.community.fancygifdialoglib;
...
public class FancyGifDialog {
    ...
    public static class Builder {
        ...
        public FancyGifDialog build() {
         ...
         //   title1.setTextColor(getColor(context, titleTxtColor));
         //   message1.setTextColor(getColor(context, desTxtColor));
            ...
            pbgShape.setColor(getColor(context, pBtnColor));
            GradientDrawable nbgShape = (GradientDrawable) nBtn.getBackground();
            nbgShape.setColor(getColor(context, nBtnColor));
            if (pListener != null) {
