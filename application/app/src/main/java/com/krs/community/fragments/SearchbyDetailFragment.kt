...
class SearchbyDetailFragment : Fragment(), OnBackPressedListener,RecyclerAdapter.ItemClickListener {
    ...
    companion object {
        ...
        const val TAG = "SearchbyDetailFragment"
        fun newInstance(coordinates: FloatArray, adapterPosition: Int): SearchbyDetailFragment {
            ...
            return SearchbyDetailFragment().apply { arguments = bundle }
        }
    }
