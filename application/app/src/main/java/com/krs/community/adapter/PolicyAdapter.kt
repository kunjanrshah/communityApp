...
class PolicyAdapter(private val mContext: Context) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        viewHolder.btnContinue.setOnClickListener {
            Guru.putBoolean("policy", true)
            LoginActivity.polictyDialog?.dismiss()
            RegisterActivty.polictyDialog?.dismiss()
