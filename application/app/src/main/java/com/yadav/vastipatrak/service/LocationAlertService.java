package com.yadav.vastipatrak.service;
...
import static com.yadav.vastipatrak.utils.Common.CalculationByDistance;
import static com.yadav.vastipatrak.utils.Common.round;
...
*/
    ...
    public class getDistance extends AsyncTask<Double, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            String notification = "Distance from " + name + " is " + s + " at " + dateToStr, title = getString(R.string.app_name), timestamp = "";
