...
import com.yadav.samaj.activity.MainActivity;
...
import static com.yadav.samaj.utils.Common.isOnline;
        ...
        try {
            ...
            if (success.equalsIgnoreCase(Common.Constant_Class.TRUE)) {
                ...
                for (int i = 0; i < mJsonArray.length(); i++) {
                    ...
                    String user_code = mJsondata.getString(Common.Constant_Class.USER_CODE);
