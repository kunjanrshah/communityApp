...
import com.yadav.samaj.fragments.BusinessFragment;
import com.yadav.samaj.fragments.FamilyFragment;
import com.yadav.samaj.fragments.FamilyTreeFragment;
import com.yadav.samaj.fragments.FragmentDrawer;
import com.yadav.samaj.fragments.PersonalFragment;
import com.yadav.samaj.fragments.RelativeFragment;
...
import static com.yadav.samaj.utils.Common.Constant_Class.TITLE_SPOUSE_BLOOD_GROUP;
...
public class ProfileActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private void saveProfile(int state) {
        ...
        if (personal != null && ((PersonalFragment) personal).edtFName != null && business != null && ((BusinessFragment) business).edtOccupation != null) {
            ...
            String user_code = ((PersonalFragment) personal).edtUserCode.getText().toString().trim();
            ...
            String Gotra = "Gotra";
            if (((PersonalFragment) personal).spinnerGotra.getSelectedItem() != null) {
                Gotra = ((PersonalFragment) personal).spinnerGotra.getSelectedItem().toString().trim();
            }
            ...
            if (valid.isEmpty()) {
                ...
                mListProfileData.setUser_code(user_code);
    ...
    private void setProfileJsonObject(@NonNull ListProfileData mListProfileData, @Nullable LinearLayout child_container, @NonNull ArrayList<Integer> lst_delID) {
        ...
        try {
            ...
            mJsonObject.put(Common.Constant_Class.USER_CODE, mListProfileData.getUser_code());
