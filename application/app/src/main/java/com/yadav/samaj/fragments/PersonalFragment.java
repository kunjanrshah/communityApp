...
import com.yadav.samaj.activity.AdvanceSearchActivity;
import com.yadav.samaj.activity.LoginActivity;
import com.yadav.samaj.activity.ProfileActivity;
import com.yadav.samaj.activity.SelectionlistActivity;
import com.yadav.samaj.app.AppController;
import com.yadav.samaj.model.ListProfileData;
import com.yadav.samaj.service.MyLocationService;
...
import static com.yadav.samaj.activity.ProfileActivity.chooseFragment;
import static com.yadav.samaj.utils.Common.Constant_Class.BIRTH_DATE;
import static com.yadav.samaj.utils.Common.ddMMMyyyy;
...
public class PersonalFragment extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    public EditText edtFName, edtLName, edtFatherName, edtMotherName, edtMobile, edtAddress, edt_Eaddress, edt_phone, edtbTime = null, edtUserCode = null;
    ...
    private void MemoryAllocation(View rootView) {
        ...
        mEditor.apply();
        edtUserCode = rootView.findViewById(R.id.edtUserCode);
        ...
        edtMobile = rootView.findViewById(R.id.edtMobile1);
        ...
        spinnerGotra = rootView.findViewById(R.id.spinnerGotra1);
        ...
        if (mSharedPreferences.getString(Common.Constant_Class.ROLE, Common.Constant_Class.USER).equals(Common.Constant_Class.ADMIN)) {
            ...
            edtUserCode.setKeyListener(null);
            edtUserCode.setCursorVisible(false);
        }
    }
    ...
    private void setOfflineData(ListProfileData mListProfileData) {
        ...
        if (mListProfileData != null) {
            ...
            edtUserCode.setText(mListProfileData.getUser_code());
