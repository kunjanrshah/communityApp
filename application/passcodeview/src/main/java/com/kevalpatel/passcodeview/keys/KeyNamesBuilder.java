...
public final class KeyNamesBuilder {
    /**
     * Title of the backspace key. This title cannot be change by the application. For title "-1",
     * Passcode view is programmed to display backspace icon.
     *
     * @see #getValueOfKey(String)
     */
    public static final String BACKSPACE_TITLE = "-1";

    // Default key names. These are standard english key names.
    ...
    /**
     * @return Get the name of the key one.
     */
    ...
    /**
     * Get the value of the key based on the key name. Key name can be localised.
     *
     * @param keyName Name of the key. (e.g. 1)
